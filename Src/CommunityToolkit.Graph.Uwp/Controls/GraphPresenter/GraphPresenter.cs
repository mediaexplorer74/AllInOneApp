...
namespace CommunityToolkit.Graph.Uwp.Controls
{
    ...
    public class GraphPresenter : ContentPresenter
    {
        ...
        private async void GraphPresenter_Loaded(object sender, RoutedEventArgs e)
        {
            ...
            {
                var request = new BaseRequest(this.RequestBuilder.RequestUrl, this.RequestBuilder.Client)
                {
                ...
                try
                {
                    ...
                    if (responseObj is JsonElement responseElement)
                    {
                        ...
                        // Replace EnqueueAsync with TryEnqueue
                        dispatcherQueue.TryEnqueue(() => this.Content = data);
                    }
                }
                catch
                {

    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void Authenticate(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                //user = await graphClient.Me.Me().GetAsync();

                //Get user profile image.
                try
                {
                    var requPicture = await graphClient.Me.Photo.Content.Request().GetAsync();
        ...
        private async static Task<GraphServiceClient> SignInAndInitializeGraphServiceClient(string[] scopes)
        {
            ...
            var graphClient = new GraphServiceClient(/*authProvider*/default, MSGraphURL);

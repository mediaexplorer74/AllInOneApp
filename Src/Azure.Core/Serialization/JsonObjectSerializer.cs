...
namespace Azure.Core.Serialization
{
    ...
    public class JsonObjectSerializer : ObjectSerializer, IMemberNameConverter
    {
        ...
        /// <inheritdoc />
        public override async /*Value*/Task SerializeAsync(Stream stream, object? value, Type inputType, CancellationToken cancellationToken)
        {
        ...
        /// <inheritdoc />
        public override /*Value*/Task<object?> DeserializeAsync(Stream stream, Type returnType, CancellationToken cancellationToken)
        {

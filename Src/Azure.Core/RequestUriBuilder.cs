...
namespace Azure.Core
{
    ...
    public class RequestUriBuilder
    {
        ...
        private bool HasDefaultPortForScheme =>
            (Port == 80 && string.Equals(Scheme, "http", StringComparison.CurrentCultureIgnoreCase)) ||
            (Port == 443 && string.Equals(Scheme, "https", StringComparison.CurrentCultureIgnoreCase));

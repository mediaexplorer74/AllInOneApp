...
#pragma warning restore AZC0102 // Do not use GetAwaiter().GetResult().
        ...
        /// <inheritdoc />
        public sealed override /*Value*/Task ProcessAsync(HttpMessage message) => ProcessAsync(message, true);

#pragma warning disable CA1801 // async parameter unused on netstandard
        private async /*Value*/Task ProcessAsync(HttpMessage message, bool async)

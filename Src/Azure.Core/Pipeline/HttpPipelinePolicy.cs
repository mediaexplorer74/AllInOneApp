...
namespace Azure.Core.Pipeline
{
    ...
    public abstract class HttpPipelinePolicy
    {
        ...
        public abstract /*Value*/Task ProcessAsync(HttpMessage message, ReadOnlyMemory<HttpPipelinePolicy> pipeline);
        ...
        /// <returns>The <see cref="/*Value*/Task"/> representing the asynchronous operation.</returns>
        protected static /*Value*/Task ProcessNextAsync(HttpMessage message, ReadOnlyMemory<HttpPipelinePolicy> pipeline)
        {

...
namespace Azure.Core.Pipeline
{
    internal class RequestActivityPolicy : HttpPipelinePolicy
    {
        ...
        private async /*Value*/Task ProcessAsync(HttpMessage message, ReadOnlyMemory<HttpPipelinePolicy> pipeline, bool async)
        {
            ...
            var diagnosticSourceActivityEnabled = s_diagnosticSource.IsEnabled(
        ...
        private static /*Value*/Task ProcessNextAsync(HttpMessage message, 
            ReadOnlyMemory<HttpPipelinePolicy> pipeline, bool async)
        {

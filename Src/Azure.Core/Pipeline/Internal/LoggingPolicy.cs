...
#pragma warning restore // ReadAsync(Memory<>) overload is not available in all targets
        ...
        private readonly struct ContentEventSourceWrapper
        {
            ...
            public async /*Value*/Task LogAsync(string requestId, bool isError, Stream? stream, Encoding? textEncoding, bool async)
            {
            ...
            public async /*Value*/Task LogAsync(string requestId, RequestContent? content, Encoding? textEncoding, bool async)
            {
            ...
            private async /*Value*/Task<byte[]> FormatAsync(RequestContent requestContent, bool async)
            {
            ...
            private async /*Value*/Task<byte[]> FormatAsync(Stream content, bool async)
            {
                using var memoryStream = new MaxLengthStream(_maxLength);

...
namespace Azure.Core.Pipeline
{
    ...
    public class HttpPipeline
    {
        ...
        /// <returns>The <see cref="/*Value*/Task"/> representing the asynchronous operation.</returns>
        public /*Value*/Task SendAsync(HttpMessage message, CancellationToken cancellationToken)
        {
        ...
        /// <param name="cancellationToken">The <see cref="CancellationToken"/> to use.</param>
        /// <returns>The <see cref="/*Value*/Task{T}"/> representing the asynchronous operation.</returns>
        public async /*Value*/Task<Response> SendRequestAsync(Request request, CancellationToken cancellationToken)
        {

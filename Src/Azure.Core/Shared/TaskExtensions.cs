...
namespace Azure.Core.Pipeline
{
    internal static class TaskExtensions
    {
        ...
        /*
        public static WithCancellationValueTaskAwaitable<T>
            AwaitWithCancellation<T>(this / * Value * / Task<T> task,
...
#pragma warning restore AZC0102 // Do not use GetAwaiter().GetResult(). Use the TaskExtensions.EnsureCompleted() extension method instead.
        ...
        /*
        public static T EnsureCompleted<T>(this / * Value * / Task<T> task)
        {
#if DEBUG
            VerifyTaskCompleted(task.IsCompleted);
#endif
...
#pragma warning restore AZC0102 // Do not use GetAwaiter().GetResult(). Use the TaskExtensions.EnsureCompleted() extension method instead.
        ...
        */
        ...
        /*
        public static void EnsureCompleted(this / * Value * / Task task)
        {
#if DEBUG
            VerifyTaskCompleted(task.IsCompleted);
#endif
...
#pragma warning restore AZC0102 // Do not use GetAwaiter().GetResult(). Use the TaskExtensions.EnsureCompleted() extension method instead.
        ...
        */
        ...
        /*
        public static Enumerable<T> EnsureSyncEnumerable<T>(
            this IAsyncEnumerable<T> asyncEnumerable) => 
            new Enumerable<T>(asyncEnumerable);
        */

        public static ConfiguredTaskAwaitable<T> EnsureCompleted<T>(
            this ConfiguredTaskAwaitable<T> awaitable, bool async)
        {
            if (!async)
            {
#if DEBUG
        ...
        public static ConfiguredTaskAwaitable EnsureCompleted
            (this ConfiguredTaskAwaitable awaitable, bool async)
        {
            if (!async)
            {
#if DEBUG
        ...
        {
            private readonly IEnumerable<T> _asyncEnumerable;

            public Enumerable(IEnumerable<T> asyncEnumerable) => _asyncEnumerable = asyncEnumerable;

            public Enumerator<T> GetEnumerator() => new Enumerator<T>(_asyncEnumerable.GetEnumerator());

            IEnumerator<T> IEnumerable<T>.GetEnumerator() => new Enumerator<T>(_asyncEnumerable.GetEnumerator());
        ...
        {
            private readonly IEnumerator<T> _asyncEnumerator;//IAsyncEnumerator

            public Enumerator(IEnumerator<T> asyncEnumerator) 
                => _asyncEnumerator = asyncEnumerator;

#pragma warning disable AZC0107 // Do not call public asynchronous method in synchronous scope.
            public bool MoveNext() => _asyncEnumerator.MoveNext();//.EnsureCompleted();
...
#pragma warning disable AZC0107 // Do not call public asynchronous method in synchronous scope.
            public void Dispose() => _asyncEnumerator.Dispose();//.EnsureCompleted();
#pragma warning restore AZC0107 // Do not call public asynchronous method in synchronous scope.
        }
        ...
        public readonly struct WithCancellationTaskAwaitable
        {
            ...
            public WithCancellationTaskAwaitable(Task task, 
                CancellationToken cancellationToken)
            {
        ...
        public readonly struct WithCancellationValueTaskAwaitable<T>
        {
            ...
            public WithCancellationValueTaskAwaitable(/*Value*/Task<T> task, 
                CancellationToken cancellationToken)
            {
                _awaitable = task.ConfigureAwait(false);
                _cancellationToken = cancellationToken;
            ...
            public WithCancellationValueTaskAwaiter<T> GetAwaiter() => 
                new WithCancellationValueTaskAwaiter<T>(_awaitable.GetAwaiter(), _cancellationToken);
        }
        ...
        {
            private readonly CancellationToken _cancellationToken;
            private readonly ConfiguredTaskAwaitable<T>
                .ConfiguredTaskAwaiter _taskAwaiter;

            public WithCancellationValueTaskAwaiter(

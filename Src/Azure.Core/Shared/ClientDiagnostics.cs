...
namespace Azure.Core.Pipeline
{
    internal sealed partial class ClientDiagnostics : DiagnosticScopeFactory
    {
        ...
        public ClientDiagnostics(ClientOptions options) : base(
            ...
            GetResourceProviderNamespace(options.GetType().GetTypeInfo().Assembly),
...
#pragma warning restore CA1822
        ...
        public async /*Value*/Task<RequestFailedException> CreateRequestFailedExceptionAsync(Response response, string? message = null, string? errorCode = null, IDictionary<string, string>? additionalInfo = null, Exception? innerException = null)
        {
        ...
        public async /*Value*/Task<string> CreateRequestFailedMessageAsync(Response response, string? message, string? errorCode, IDictionary<string, string>? additionalInfo, bool async)
        {
        ...
        private static async /*Value*/Task<string?> ReadContentAsync(Response response, bool async)
        {
            string? content = null;
        ...
        {
            foreach (var customAttribute in assembly.GetCustomAttributes(/*true*/default))
            {
                ...
                {
                    return attributeType.GetTypeInfo()
                        .GetDeclaredProperty("ResourceProviderNamespace")?.GetValue(
                            customAttribute) as string;
                }
            }
